...
import Persistencia.DAOFuncionalidad;
...
public class JFuncionalidad {
	...
	private void initialize() {
		...
		listarFuncionalidades.addActionListener (new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				String Funciones = DAOFuncionalidad.Funcionalidades();
	...
	public void actionPerformed(ActionEvent e) {
	  ...
	  String nombre_1 = JOptionPane.showInputDialog("Nombre: ");
	    String busquedaFuncion = DAOFuncionalidad.findFuncionalidad(nombre_1);
	...
	Agregar.addActionListener (new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
			...
			int id = DAOFuncionalidad.maximo(); 
	...
	Modificar.addActionListener (new ActionListener() {
		...
		@Override
		public void actionPerformed(ActionEvent e) {
			Funcionalidad g = new Funcionalidad();
			mainDisplay.setText(null);
			scrollPane_2.setVisible(true);
			...
			g.setNombre(JOptionPane.showInputDialog("Nuevo nombre de la Funcionalidad: "));
			g.setDescripcion(JOptionPane.showInputDialog("Nueva descripcion de la Funcionalidad: "));
			g.setId(id_1);
            if (DAOFuncionalidad.edit(g)) {	
	...
	Eliminar.addActionListener (new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (DAOFuncionalidad.delete(id_2)) {	
